...
| Codex 能力 | 当前状态 | Enchanted 验收标准 |
|---|---:|---|
| 流式回答、thinking、tool cards | ✅ | 文本/推理/工具顺序稳定，长会话不白屏 |
...
| Changes / Diff | ✅ | 状态、统计、着色、打开、Stage/Unstage、确认式 Discard |
...
| Hooks / Rules / AGENTS.md | 🟡 | pi 可读取项目说明；需 UI 状态与机械执行入口 |
